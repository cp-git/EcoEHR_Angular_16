...
export class MasterLookupService {
    ...
    getAddressState(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getAddressStateUrl, {headers});
    ...
    getTitles(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getTitleUrl, {headers});
        // let cpHeaders = new Headers({ 'Content-Type': 'application/json', "x-auth-token": localStorage.getItem('jwt') });
        // let cpParams = new URLSearchParams();
        // let options = new RequestOptions({ headers: cpHeaders, params: cpParams });
    ...
    getLanguage(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getLangUrl, {headers});
        // let cpHeaders = new Headers({ 'Content-Type': 'application/json', "x-auth-token": localStorage.getItem('jwt') });
        // let cpParams = new URLSearchParams();
        // let options = new RequestOptions({ headers: cpHeaders, params: cpParams });
    ...
    getRace(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getRaceUrl, {headers});
    ...
    getCredentials(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getCredentialsUrl, {headers});
        // let cpHeaders = new Headers({ 'Content-Type': 'application/json', "x-auth-token": localStorage.getItem('jwt') });
        // let cpParams = new URLSearchParams();
        // let options = new RequestOptions({ headers: cpHeaders, params: cpParams });
    ...
    getProviderTypes(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getProviderTypesUrl, {headers});
        // let cpHeaders = new Headers({ 'Content-Type': 'application/json', "x-auth-token": localStorage.getItem('jwt') });
        // let cpParams = new URLSearchParams();
        // let options = new RequestOptions({ headers: cpHeaders, params: cpParams });
    ...
    getPatientStatus(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getPatientStatusUrl, {headers});
        // let cpHeaders = new Headers({ 'Content-Type': 'application/json', "x-auth-token": localStorage.getItem('jwt') });
        // let cpParams = new URLSearchParams();
        // let options = new RequestOptions({ headers: cpHeaders, params: cpParams });
    ...
    getLookUpTypeAsRefill(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getRefillUrl, {headers});
    ...
    getFrequency(): Observable<MasterLookup[]> {
		...
		return this.http.get<MasterLookup[]>(this.getFrequencyUrl, {headers});
                // let cpHeaders = new Headers({ 'Content-Type': 'application/json', "x-auth-token": localStorage.getItem('jwt') });
                // let cpParams = new URLSearchParams();
                // let options = new RequestOptions({ headers: cpHeaders, params: cpParams });
                // return this.http.get(this.getFrequencyUrl, options)
